...
# train(500, train_o, batch_size=bs, lr=0.0002, n_save=6, gupt=3, startep=295)

# begin training
gen, critic, siam, [opt_gen, opt_disc] = get_networks(shape, load_model=False)
train(500, train_o, batch_size=bs, lr=0.0002, n_save=6, gupt=3)